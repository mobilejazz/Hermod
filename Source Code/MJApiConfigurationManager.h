 ...
 **/
@interface MJApiConfiguration : NSObject
 ...
 * - Finally, add other keys that will be listed in the `apiInfo` property of `MJApiEnvironment`.
 *
 **/
@interface MJApiConfigurationManager : NSObject
 ...
 *
 *  - Use `MJApiEnvironmentStaging` for key "staging"
 *  - Use `MJApiEnvironmentProduction` for key "production"
 *  - Use `MJApiEnvironmentDevelopment` for key "development"
 *  - Use custom keys to get custom specified environments.
 **/
- (MJApiConfiguration *)configurationForEnvironment:(MJApiEnvironment *)environment;
