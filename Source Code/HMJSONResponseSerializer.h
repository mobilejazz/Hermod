 ...
 **/
extern NSString * const HMJSONResponseSerializerBodyKey;
 ...
 * Use the key `HMJSONResponseSerializerBodyKey` to access to the JSON response object in the `NSError`'s `userInfo` dictionary.
 **/
@interface HMJSONResponseSerializer : AFJSONResponseSerializer
