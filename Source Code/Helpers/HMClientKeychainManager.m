...
@implementation HMClientKeychainManager

#pragma mark Static Methods

+ (HMClientKeychainManager*)managerForService:(NSString*)service
{
    ...
    @synchronized(self)
    {
        ...
        if (!sharedObject)
        {
            sharedObject = [[HMClientKeychainManager alloc] initWithService:service];
...
+ (HMClientKeychainManager*)defaultManager
{
    HMClientKeychainManager *manager = [self managerForService:[[NSBundle mainBundle] bundleIdentifier]];
    return manager;
}
