...
@interface MJApiConfiguration ()

- (id)initWithDictionary:(NSDictionary *)dictionary;

@end

@implementation MJApiConfiguration
...
@implementation MJApiConfigurationManager
{
    NSDictionary *_plist;
...
{
    MJApiConfiguration *config = _dictionary[environment];
    ...
    if (!config)
    {
        ...
        if (dictionary)
        {
            config = [[MJApiConfiguration alloc] initWithDictionary:dictionary];
